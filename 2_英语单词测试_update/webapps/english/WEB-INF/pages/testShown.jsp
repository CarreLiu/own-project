...
<html lang="zh-CN">
  <head>
	...
	<script type="text/javascript">
		...
		$('#frmSearchTests').bootstrapValidator({
	  	...
	  	function initTable() {
			...
			$("#cusTable").bootstrapTable({
				...
				url : "${pageContext.request.contextPath}/test/findTestsByPage.action", //要请求数据的文件路径
      ...
      $(function() {
    	  ...
    	  //服务器繁忙
    	  let serviceBusyMsg = '${serviceBusyMsg}';
    	  if (serviceBusyMsg != '') {
    		  layer.msg(serviceBusyMsg, {
    			  time:2000,
    			  skin:'errorMsg'
    		  });
    	  }
      ...
      function viewDetail(id) {
    	  window.location = "${pageContext.request.contextPath}/test/toTestDetail.action?id="+id;
      }
	    //时间戳格式化处理
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/english/WebRoot/WEB-INF/pages/testShown.jsp">
	<% request.setAttribute("index", 2); %>
	<jsp:include page="top.jsp"/>
    <div class="container text-center" style="margin-top: 20px;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/english/WebRoot/WEB-INF/pages/testShown.jsp">
      <form class="form-inline" id="frmSearchTests" action="/action" method="post">
        ...
        <div class="form-group">
          ...
          <select class="form-control" style="margin-right: 25px;" name="testTypeId" id="testTypeId">
            ...
            <option selected="selected" value="0">全部记录</option>
        ...
        <div class="form-group">
          <input class="btn btn-primary btn-block" id="searchBtn" type="button" value="查询记录" />
        </div>
      </form>
    </div>
