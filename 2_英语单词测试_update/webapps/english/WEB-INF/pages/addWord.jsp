...
<html lang="zh-CN">
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/english/WebRoot/WEB-INF/pages/addWord.jsp">
	<% request.setAttribute("index", 0); %>
	<jsp:include page="top.jsp"/>
    <div class="container" id="containers" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/english/WebRoot/WEB-INF/pages/addWord.jsp">
