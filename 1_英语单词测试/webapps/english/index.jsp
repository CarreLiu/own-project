...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-10" data-genuitec-path="/english/WebRoot/index.jsp">
    <%
     	response.sendRedirect(request.getContextPath()+"/words/toAddWord.action");
      %>
  </body>
</html>
